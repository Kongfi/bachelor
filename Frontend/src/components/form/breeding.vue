  ...
  data() {
    return {
      ...
      options: [
        ...
        {
          label: "Insemination med kølesæd",
          value: "coldSeed"
        },
        {
          label: "Insemination med frostsæd",
          value: "frozenSeed"
        },
        {
          label: "Ægtransplantation",
          value: "eggTransplant"
        }
      ]
    };
